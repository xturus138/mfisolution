<section id="home"
         class="relative h-[800px] lg:h-[699px] overflow-hidden flex items-center">
    ...
    {{-- Content --}}
    <div class="relative z-10 max-w-[1366px] mx-auto px-4 md:px-6 lg:px-[100px] w-full">
        <div class="flex flex-col gap-4 max-w-[800px] items-center text-center lg:items-start lg:text-left mx-auto lg:mx-0">
            ...
            <div class="flex flex-col gap-2">
                <h1 class="text-white font-bold text-2xl md:text-4xl lg:text-[48px] leading-[1.2]">
            ...
            {{-- CTAs --}}
            <div class="flex flex-wrap gap-6 items-center justify-center lg:justify-start w-full">
                <a href="#product"
